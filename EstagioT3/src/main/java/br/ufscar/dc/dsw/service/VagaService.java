...
public class VagaService {
    ...
    // Novo método: busca apenas as vagas em aberto de uma empresa específica
    public List<Vaga> buscarVagasAbertasPorEmpresa(Empresa empresa) {
        Date hoje = new Date();
        return dao.findByEmpresaAndDataLimiteInscricaoAfter(empresa, hoje); // Filtra vagas em aberto pela data
    }
}
